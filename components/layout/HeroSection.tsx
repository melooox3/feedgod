...
export default function HeroSection() {
  ...
  return (
    <section className="text-center pt-20 pb-16 md:pt-28 md:pb-20 px-4">
      ...
      {/* Build Oracle Secondary CTA */}
      <button
        onClick={() => document.getElementById('modules')?.scrollIntoView({ behavior: 'smooth' })}
        className="ml-4 inline-flex items-center gap-2 px-6 py-4 border border-gray-600 hover:border-feedgod-primary rounded-xl text-white font-medium transition-all duration-300 hover:bg-feedgod-primary/10 animate-fade-in animate-delay-1"
      >
        <Hammer className="w-5 h-5" />
        <span className="text-lg">Build Oracle</span>
      </button>
