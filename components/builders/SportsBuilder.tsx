  ...
  useEffect(() => {
    ...
    if (smartData) {
      try {
        ...
        if (module === 'sports' && parsed) {
          // Set team search query
          if (parsed.team) {
            setSearchQuery(parsed.team)
          }
          // Note: League matching would require more complex logic
          // For now, just set the search to help user find the match
        }
      } catch (e) {
